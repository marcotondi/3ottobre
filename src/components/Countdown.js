    ...
    <>
      <div className="tile is-ancestor">
        ...
        <div className="tile is-parent is-2">
          <div title="Add to Calendar" className="addeventatc is-size-6 is-size-7-touch">
            Add to Calendar
            ...
            <span className="location">Largo Castello, 26, 73010 Lequile LE</span>
          </div>
        </div>
      ...
      <div className="tile is-parent is-3">
        <article className="tile is-child box notification has-text-centered is-danger ">
          <div className="box has-background-warning">
            ...
            <p className="subtitle is-size-5 is-size-6-touch"> {props.label} </p>
          </div>
        </article>
      </div>
    </>
